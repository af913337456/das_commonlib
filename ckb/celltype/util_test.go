...
func Test_ParseAccountData(t *testing.T) {
	printf := func(hexStr string) {
		...
		t.Log("id:", id.HexStr())
		id1, err1 := NextAccountIdFromOutputData(bys)
		if err1 != nil {
			panic(err1)
		}
		t.Log("next:", id1.HexStr())
	}
	printf("0x53f32b5a79537d5cce5a96cf8b35ba4ac342f402baae0a8d17cacd4537ccb7d955478d76900611eb079b717ce4f160d8ec367e3f000000000000000004000000")
	printf("")
}
